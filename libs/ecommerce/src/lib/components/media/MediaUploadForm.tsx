...
import { recordMediaUpload } from "@nextblock-cms/db"; // Shared Server action
        ...
        <div>
          ...
          <div className="mt-2 flex items-center justify-center w-full">
            <label
              ...
              className={`flex flex-col items-center justify-center w-full h-40 border-2 border-dashed rounded-lg cursor-pointer bg-muted/30 hover:bg-muted/50 transition-colors focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 ${
